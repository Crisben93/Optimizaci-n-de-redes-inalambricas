...
cordenada(1,U)
cordenada(2,U)
TP = [35,169;60,75;219,167;180,202;156,45];
hold on 
plot(TP(:,1),TP(:,2),'o','Color','black','LineWidth',5)
hold on
legend('Usuarios AP 1','Usuarios AP 2','Usuarios AP 3','Usuarios AP 4','Usuarios AP 5','Ubicacion de AP','AP-Combinado')