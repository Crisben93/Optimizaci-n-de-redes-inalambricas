...
for yp = 4:3:267 % No se considera el borde del plano
    for xp = 4:3:247
...
title('Resolucion de pixeles elegidos','interpreter','latex','fontsize',16')
...
title('Simulador de Propagacion de señales radioelectricas ','interpreter','latex','fontsize',12')
%% Repitar los muros
% jm = 0;
